...
export default class extends window.Controller {
    ...
    connect() {
        ...
        tinymce.init({
            ...
            hidden_input: false,
            menubar: false,
            quickbars_insert_toolbar: 'table link',
            quickbars_selection_toolbar:
                'bold italic | quicklink h2 h3 | alignleft aligncenter alignright alignjustify | outdent indent | link unlink | removeformat forecolor',
